 ...
 */
export declare type UIMErrorCode = APIErrorCode | ClientErrorCode;
/**
 * Base error type.
 */
declare abstract class UIMClientErrorBase<Code extends UIMErrorCode> extends Error {
    abstract code: Code;
}
/**
 * Error type that encompasses all the kinds of errors that the UIM client will throw.
 */
export declare type UIMClientError = RequestTimeoutError | UnknownHTTPResponseError | APIResponseError;
/**
 * @param error any value, usually a caught error.
 * @returns `true` if error is a `UIMClientError`.
 */
export declare function isUIMClientError(error: unknown): error is UIMClientError;
/**
 * Error thrown by the client if a request times out.
 */
export declare class RequestTimeoutError extends UIMClientErrorBase<ClientErrorCode.RequestTimeout> {
...
declare class HTTPResponseError<Code extends HTTPResponseErrorCode> extends UIMClientErrorBase<Code> {
