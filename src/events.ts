...
// 账号在线状态变化
export type AccountPresenceChangedEvent = ClientEvent<
  Pick<Account, "id" | "presence">
>
// 账号总未读数量变化
export type AccountUnreadCountEvent = ClientEvent<
  Pick<Account, "id" | "unread">
>
// 新好友
...
// 会话未读数量变化
export type ConversationUnreadCountEvent = ClientEvent<
...
// 群成员被踢出群
export type GroupMemberKickedEvent = ClientEvent<
  Pick<GroupMember, "id" | "group_id" | "nickname" | "avatar">
>
// 群成员主动退群
export type GroupMemberQuitedEvent = ClientEvent<
  Pick<GroupMember, "id" | "group_id" | "nickname" | "avatar">
>
